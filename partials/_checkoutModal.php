        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="address1" name="address1" placeholder="Saudi Arabia Mecca Street " type="text">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6 mb-0">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone" placeholder="xxxxxxxxxx" required pattern="[0-9]{9}" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group col-md-6 mb-0">
